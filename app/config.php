...
$configs = [
    ...
    'cmf_iconfint_add'    => '<i class="fa fa-plus-square-o"></i>',
    'cmf_iconfint_edit'   => '<i class="fa fa-edit"></i>',
    'cmf_iconfint_delete' => '<i class="fa fa-trash-o"></i>',
    'cmf_iconfint_on'     => '<i class="fa fa-toggle-on"></i>',
    'cmf_iconfint_off'    => '<i class="fa fa-toggle-off"></i>',
    'cmf_iconfint_check'  => '<i class="fa fa-check-circle"></i>',
    'cmf_iconfint_ban'    => '<i class="fa fa-ban"></i>',
    'cmf_envelope_ban'    => '<i class="fa fa-envelope"></i>',
    'cmf_fa_user'         => '<i class="fa fa-user"></i>',
    'cmf_fa_weixin'       => '<i class="fa fa-weixin"></i>',
    'cmf_fa_archive'       => '<i class="fa fa-archive"></i>',
];
